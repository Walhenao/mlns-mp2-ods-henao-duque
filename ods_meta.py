...
ODS_BLURB = {
    ...
    4: "Garantizar una educacion inclusiva, equitativa y de calidad.",
    5: "Lograr la igualdad entre los generos y empoderar a las mujeres.",
    6: "Garantizar la disponibilidad de agua y saneamiento.",
    7: "Garantizar el acceso a energia asequible y sostenible.",
    8: "Promover el crecimiento economico y el trabajo decente.",
    9: "Construir infraestructuras e impulsar la innovacion.",
    ...
    13: "Adoptar medidas urgentes contra el cambio climatico.",
    14: "Conservar y utilizar de forma sostenible los oceanos.",
    15: "Proteger, restablecer y promover el uso sostenible de los ecosistemas.",
    16: "Promover sociedades pacificas e instituciones eficaces.",
}
